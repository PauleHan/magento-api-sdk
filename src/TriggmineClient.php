...
/**
 * Default Triggmine client implementation
 */
class TriggmineClient implements TriggmineClientInterface
{
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (Triggmine\Credentials\CredentialsInterface|array|bool|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   Triggmine\Credentials\CredentialsInterface object, an associative array of
     *   "key", "secret", and an optional "token" key, `false` to use null
     *   credentials, or a callable credentials provider used to create
     *   credentials or return null. See Triggmine\Credentials\CredentialProvider for
     ...
     *   accepts a hash of options including a "service" key and
     *   returns NULL or a hash of endpoint data, of which the "endpoint" key
     *   is required. See Triggmine\Endpoint\EndpointProvider for a list of built-in
     *   providers.
     * - handler: (callable) A handler that accepts a command object,
     *   request object and returns a promise that is fulfilled with an
     *   Triggmine\ResultInterface object or rejected with an
     *   Triggmine\Exception\TriggmineException. A handler does not accept a next handler
     ...
     *   credentials are created from the Triggmine credentials file in your HOME
     *   directory. This setting overrides the Triggmine_PROFILE environment
     ...
     *   version name (e.g., "v3"), a service name and
     *   returns a SignatureInterface object or null. This provider is used to
     *   create signers utilized by the client. See
     *   Triggmine\Signature\SignatureProvider for a list of built-in providers
     * - signature_version: (string) A string representing a custom
     *   signature version to use with a service (e.g., v3). Note that
