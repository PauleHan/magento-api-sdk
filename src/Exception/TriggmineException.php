...
/**
 * Represents an Triggmine exception that is thrown when a command fails.
 */
class TriggmineException extends \RuntimeException
{
     ...
     */
    public function getTriggmineRequestId()
    {
        return $this->requestId;
    }

    /**
     * Get the Triggmine error type.
     *
     * @return string|null Returns null if no response was received
     */
    public function getTriggmineErrorType()
    {
        return $this->errorType;
    }

    /**
     * Get the Triggmine error code.
     *
     * @return string|null Returns null if no response was received
     */
    public function getTriggmineErrorCode()
    {
