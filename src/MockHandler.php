 ...
 * Triggmine\ResultInterface and Triggmine\Exception\TriggmineException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see Triggmine\ResultInterface} or
     * {@see TriggmineException} objects that acts as a queue of results or
    ...
    /**
     * Adds one or more variadic ResultInterface or TriggmineException objects to the
     * queue.
     */
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                || $value instanceof TriggmineException
                || is_callable($value)
            ) {
                $this->queue[] = $value;
            } else {
                throw new \InvalidArgumentException('Expected an Triggmine\ResultInterface or Triggmine\Exception\TriggmineException.');
            }
        }
    }
