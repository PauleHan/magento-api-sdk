...
use Triggmine\Api\Serializer\QuerySerializer;
use Triggmine\Api\Serializer\Ec2ParamBuilder;
use Triggmine\Api\Parser\QueryParser;
...
class Service extends AbstractModel
{
    ...
    public static function createSerializer(Service $api, $endpoint)
    {
        static $mapping = [
            ...
            'rest-xml'  => 'Triggmine\Api\Serializer\RestXmlSerializer'
        ];
    ...
    public static function createErrorParser($protocol)
    {
        static $mapping = [
            ...
            'rest-xml'  => 'Triggmine\Api\ErrorParser\XmlErrorParser',
            'ec2'       => 'Triggmine\Api\ErrorParser\XmlErrorParser'
        ];
    ...
    public static function createParser(Service $api)
    {
        static $mapping = [
            ...
            'rest-xml'  => 'Triggmine\Api\Parser\RestXmlParser'
        ];
     ...
     *
     * Note: this method assumes "v3" when not specified in the model.
     *
     * @return string
     */
    public function getSignatureVersion()
    {
        return $this->definition['metadata']['signatureVersion'] ?: 'v3';
    }
